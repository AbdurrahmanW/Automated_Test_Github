...
time.sleep(1)
driver.find_element_by_id("login_field").send_keys("email/username") # change the email/username
time.sleep(1)
driver.find_element_by_id("password").send_keys("password") #change password
time.sleep(1)
...
time.sleep(5)
driver.close()
print ("Succes login and log out")